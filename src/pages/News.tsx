    ...
    <section className="w-full flex flex-col lg:flex-row">
      ...
      <div className="lg:p-24 flex flex-col gap-10 m-5">
        <article className="flex flex-col gap-5">
          ...
          <h5 className="italic">18 June 2025</h5>
          <p className="text-justify">
            <a
              href="oppose-NC2-and-NC3.pdf"
              target="_blank"
        ...
        <article className="flex flex-col gap-5">
          ...
          <p className="text-justify">
            {language === "English"
              ...
              : "Mae clymblaid Diogelwch yn Gyntaf Cymru wedi lansio fis yma gyda’r nod o ddad-droseddoli gwaith rhyw ac i sicrhau bod diogelwch, iechyd a lles gweithwyr rhyw yn cael eu blaenoriaethu yng Nghymru."}
          </p>
          <p className="text-justify">
            {language === "English"
              ...
              : "Mae ein papur briffio yn nodi profiadau gweithwyr rhyw yn ein rhwydwaith ac yn cynnwys cynigion ar gyfer newid, y gallai nifer ohonyn nhw gael eu gweithredu ar unwaith gan y Senedd."}
          </p>
          <p className="text-justify">
            {language === "English"
          ...
          <ol className="list-decimal px-4 text-justify">
            <li>
              {language === "English"
                ? "The decriminalisation of sex work to improve sex workers’ health, safety and welfare."
                : "Dad-droseddoli gwaith rhyw i wella diogelwch, iechyd a lles gweithwyr rhyw."}
            </li>
            <li>
              {language === "English"
                ? "The provision of financial support for sex workers wishing to exit sex work."
